    ...
    <div className="mx-auto max-w-3xl px-4 py-6 sm:py-10">
      <header className="panel-raised">
        ...
        <div className="border-b-2 border-ink px-4 py-8 text-center sm:py-12">
          <p className="text-[11px] font-semibold tracking-tight text-ink-soft uppercase">Total score</p>
          <p className="mt-2 flex items-baseline justify-center gap-2 leading-none">
            <span className="text-6xl font-bold tracking-tight tabular-nums sm:text-8xl">{result.total}</span>
            <span className="text-2xl font-bold tracking-tight text-ink-soft tabular-nums sm:text-4xl">/ 1600</span>
          </p>
        </div>
